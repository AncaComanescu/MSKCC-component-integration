...
function DoctorBio(props) {
  ...
  return (
    <>
      ...
      <MskSiteWrapper>
        <MskGrid
          types={{ small: "100", medium: "50:50", large: "50:50" }}
          gutter={20}
        >
          <MskGridRow>
            <MskLeftRail
          ...
          <MskGridRow>
            <MskRightRail lang="en" mainContent={doctorImage} />
          </MskGridRow>
        </MskGrid>

        <MskGrid
          types={{ small: "100", medium: "50:50", large: "33:66" }}
          gutter={20}
        >
          <MskGridRow>
            {" "}
            <h2>MskNavWidget Placeholder</h2>
          </MskGridRow>
          <MskGridRow>
            <MskListBanner
        ...
        >
          ...
          <MskGridRow>
            ...
            <p>
              I am the Director of the MSK Center for Hematologic Malignancies.
              I currently spend the majority of my time in the laboratory
              investigating the underlying causes of these disorders by studying
              the genes of patient samples as well as in vitro and in vivo
              models. As a member of the Human Oncology and Pathogenesis
              Program, I have helped to identify and characterize several new
              genetic abnormalities in the diseases mentioned above. In addition
              to increasing our understanding of the causes of these disorders,
              these discoveries have promise in helping to discover targeted
              therapies.
            </p>
          </MskGridRow>
        </MskGrid>
        ...
        >
          ...
          <MskGridRow>
            ...
            <MskList isOrdered={false} lang="en">
              <MskListItem hasRemovedListStyles={true}>
                <li>
                  Seldin-Smith Award for Pioneering Research, American Society
                ...
                <li>
                  Leukemia & Lymphoma Society Clinical Scholar Award (2015)
                </li>
                <li>
                  Joanne Levy Memorial Award for Outstanding Achievement,
        ...
        >
          ...
          <MskGridRow>
            <h2>Colleagues</h2>
            <p>
              Doctors at Memorial Sloan Kettering work as teams, with
              specialists from all different areas. This allows us to consider
              all your needs together, and to give you the best possible care.
            </p>
            <MskLink
              isStandalone
        ...
        >
          ...
          <MskGridRow>
            <h2>Disclosures</h2>
            <p>
              Doctors and faculty members often work with pharmaceutical,
              device, biotechnology, and life sciences companies, and other
              organizations outside of MSK, to find safe and effective cancer
              treatments, to improve patient care, and to educate the health
              care community.
            </p>
            <p>
              MSK requires doctors and faculty members to report (“disclose”)
              the relationships and financial interests they have with external
              entities. As a commitment to transparency with our community, we
              make that information available to the public.
            </p>
            <MskList isOrdered={false} lang="en">
              <MskListItem hasRemovedListStyles={true}>
                <p>
                  Omar Abdel-Wahab discloses the following relationships and
                  financial interests:
                </p>
              </MskListItem>
              <MskListItem hasRemovedListStyles={true}>
            ...
            <p>
              If you’re a patient at MSK and would like more information about
              your doctor’s external relationships, please talk with your
              doctor.
            </p>
            <p>
              The information published here is for a specific annual disclosure
              period. There may be differences between information on this and
              other public sites as a result of different reporting periods
              and/or the various ways relationships and financial interests are
              categorized by organizations that publish such data.
            </p>
          </MskGridRow>
        </MskGrid>
        <MskGrid
        ...
        >
          ...
          <MskGridRow>
            <MskSimpleCallout ctaText="View all disclosures" ctaLink="#">
              ...
              disclosure period (January 1, 2019 through disclosure submission
              in spring 2020). This data reflects interests that may or may not
              still exist. This data is updated annually. Learn more about MSK’s
              COI policies here. For questions regarding MSK’s COI-related
              policies and procedures, email MSK’s Compliance Office at{" "}
